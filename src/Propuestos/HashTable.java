...
public interface HashTable<K, V> {
    ...
    /**
     * Retorna {@code true} Si la tabla contiene una clave determinada. Retorna
     * {@code true} si y solo si
     ...
     * @return {@code true} si la tabla contiene una o mas claves asociadas al valor
     *         determinado
     ...
     *         {@code null} si no existia previamente un reistro con la clave
     *         {@code key} y
     ...
     * Este codigo hash esta definido por la suma de todos los codigos hash de cada
     * entrada
     * de la tabla. Eso aseguraria que {@code tablaHash1.equals(tablaHash2)} en base
     * a sus hashCode,
     * es decir, implica que {@code tablaHash1.hashCode() == tablaHash2.hashCode()}
